...
class EntryDetailSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if validated_data["entry_date"].strftime("%Y-%m-%d") != today.strftime(
            "%Y-%m-%d"
        ):
        ...
        validated_data["milestone_word_count"] = dw_profile.target_milestone_word_count
    ...
    def update(self, instance, validated_data):
        ...
        return super(EntryDetailSerializer, self).update(instance, validated_data)
